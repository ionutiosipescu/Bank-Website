  ...
  return (
    <>
            ...
            <div className="container">
                <div className="main-menu--two__inner">
                    <div className="main-menu__logo">
                        <Link to="/">
                            <img src="assets/images/logo-light.png" width="140" height="51" alt="Finlon" />
                        </Link>
                    </div>
        ...
        <section className="slider-one slider-one--two">
            <OwlCarousel  ref={carouselRef} className="thm-owl__carousel thm-owl__carousel--custom-nav owl-carousel owl-theme owl-dot-style-one" data-owl-nav-prev=".slider-one__carousel__btn__left" data-owl-nav-next=".slider-one__carousel__btn__right"  {...sliderOptionsOne}  >
                <div className="item">
                    ...
                    <div className="row row-gutter-x-0">
                        <div className="col-lg-4 col-md-12">
                            <div className="service-card-four">
                                ...
                                <h3 className="service-card-four__title"><Link to="/Linkbout">Quick cash loan</Link></h3>
                                <p className="service-card-four__text">Lorem ipsum is simply dolor sit am adipi we help. </p>
                        ...
                        <div className="col-lg-4 col-md-12">
                            <div className="service-card-four">
                                ...
                                <h3 className="service-card-four__title"><Link to="/loaneligilibity">Easy online application</Link>
                                </h3>
                                <p className="service-card-four__text">Lorem ipsum is simply dolor sit am adipi we help. </p>
                        ...
                        <div className="col-lg-4 col-md-12">
                            <div className="service-card-four">
                                ...
                                <h3 className="service-card-four__title"><Link to="/creditrepair">Credit scores</Link></h3>
                                <p className="service-card-four__text">Lorem ipsum is simply dolor sit am adipi we help. </p>
                ...
                <div className="row">
                    ...
                    <div className="col-lg-6">
                        <div className="call-to-action-two__content">
                            ...
                            <Link to="/applynow" className="thm-btn">Apply For Loan</Link>
                    ...
                    <div className="col-lg-6">
                        <div className="about-one__image">
                            ...
                            <div className="about-one__image__caption">
                                <span>We're provide best facility for
                                    / wishes</span>
                            </div>
                        </div>
                    </div>
