if ($("#home-eligibility-calculator").length) {
  ...
  function age_eligibility($value2 = 25) {
    ...
    $("#eligibility-age-show").text(
      $("#eligibility-age-slider").slider("value")
    );
    $("#eligibility-age-input").val(
      $("#eligibility-age-slider").slider("value")
    );
    year_eligibility();
    loan_eligibility();
  ...
  function year_eligibility($value2 = 15) {
    ...
    $("#eligibility-year-show").text(
      $("#eligibility-year-slider").slider("value")
    );
    $("#eligibility-year-input").val(
      $("#eligibility-year-slider").slider("value")
    );
    loan_eligibility();
  }
  ...
  function income_eligibility($value2 = 25000) {
    ...
    $("#eligibility-income-show").text(
      $("#eligibility-income-slider").slider("value")
    );
    $("#eligibility-income-input").val(
      $("#eligibility-income-slider").slider("value")
    );
    loan_eligibility();
  }
  ...
  function other_emi_eligibility($value2 = 0) {
    ...
    $("#eligibility-other-show").text(
      $("#eligibility-other-slider").slider("value")
    );
    $("#eligibility-other-input").val(
      $("#eligibility-other-slider").slider("value")
    );
    loan_eligibility();
  }
  ...
  function interest_rate_eligibility($value2 = 6) {
    ...
    $("#eligibility-interest-show").text(
      $("#eligibility-interest-slide").slider("value")
    );
    $("#eligibility-rate-input").val(
      $("#eligibility-interest-slide").slider("value")
    );
    loan_eligibility();
  }
...
function loan_eligibility() {
  ...
  var income_pv = parseInt(
    $("#eligibility-income-input").val().replace(/,/g, "")
  );
  var Other_emi = parseInt(
    $("#eligibility-other-input").val().replace(/,/g, "")
  );
  ...
  jQuery("#total-amount").html(
    (Elg * 100000).toFixed(0).replace(/\B(?=(\d{3})+(?!\d))/g, ",")
  );
  jQuery("#total-emi").html(
